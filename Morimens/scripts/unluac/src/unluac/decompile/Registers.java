...
public class Registers {
  ...
  public boolean isLocal(int register, int line) {
    ...
    if(register < 0 || register >= decls.length) {
      return false;
    }
  
   
    if(line < 0 || line >= decls[register].length) {
      return false;
    }
  ...
  public Expression getExpression(int register, int line) {
    ...
    if(register < 0 || register >= values.length) {
      return null;
    }
    ...
    // ✅ Invalid line index
    if(idx < 0 || idx >= values[register].length) {
      return null;
    }
  ...
  public int getUpdated(int register, int line) {
    ...
    if(register < 0 || register >= updated.length) {
      return -1;
    }
  
    // ✅ Ignore invalid line indexes
    if(line < 0 || line >= updated[register].length) {
      return -1;
    }
  ...
  public void setValue(int register, int line, Expression expression) {
    ...
    // ✅ Ignore invalid register indices
    if(register < 0 || register >= values.length) {
      return;
    }
  
    // ✅ Ignore invalid line indices
    if(line < 0 || line >= values[register].length) {
      return;
    }
